...
WebUI.setText(findTestObject('Object Repository/search/Page_Ca hng qun o.  Vergency/input_Toggle navigation_q'), 't')

WebUI.sendKeys(findTestObject('Object Repository/search/Page_Ca hng qun o.  Vergency/input_Toggle navigation_q'), Keys.chord(
        Keys.ENTER))
